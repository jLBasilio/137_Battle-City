...
public class UDPTester extends JPanel implements Runnable{
  /**
   * Main window
   */
   ...
   * @throws Exception
   */
  public UDPTester(String server,String name) throws Exception{
    this.server=server;
    this.name=name;
    
    frame.setTitle("UDPTester: "+name);
  ...
  public static void main(String args[]) throws Exception{
    if (args.length != 2){
      System.out.println("Usage: java com.main.app.UDPTester <server> <player name>");
      System.exit(1);
    }

    new UDPTester(args[0],args[1]);
  }
}
